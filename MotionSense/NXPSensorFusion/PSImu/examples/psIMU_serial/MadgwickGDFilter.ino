...
//=======================================================
//Madgwick original Gradient Descent from paper
//=======================================================
void MARGUpdateFilter(float a_x, float a_y, float a_z, float w_x, float w_y, float w_z, float m_x, float m_y, float m_z)
{
...
void MARGUpdateFilterIMU(float a_x, float a_y, float a_z, float w_x, float w_y, float w_z )
{
    float q0 = q[0], q1 = q[1], q2 = q[2], q3 = q[3];   // short name local variable for readability
  // Local system variables
  float norm; // vector norm
